...
public class SlideDateTimePicker
{
    ...
    /**
     * Sets the rowId of the current item in the list.
     *
     * @param rowId  the rowId of the current item
     */
     ...
     * {@link #setListener(SlideDateTimeListener listener)} before calling this.
     */
    public void show()
    {
        if (mListener == null)
    ...
    public static class Builder
    {
        ...
        /**
         * @see SlideDateTimePicker#setId(int)
         */
